...
echo "CREATE TABLE ketris_users ( username_hash BINARY(16) NOT NULL, password_hash BINARY(16) NOT NULL, username_plaintext VARCHAR(256) NOT NULL, account_creation_time TINYTEXT NOT NULL, last_login DATETIME(6), creation_ip TINYTEXT, PRIMARY KEY( username_hash ) );" >> "ketris_sql_init.sql"
...
echo "CREATE TABLE ketris_messages ( author_name VARCHAR( 256 ) NOT NULL, message_body MEDIUMTEXT NOT NULL, timestamp DATETIME(6) NOT NULL, ip TINYTEXT );" >> "ketris_sql_init.sql"
